...
-- /storage/factories/storage_adapter_factory.lua
-- Factory for creating storage adapters based on peripheral type
...
-- /storage/factories/command_factory.lua
-- Factory for registering and building commands with metadata
